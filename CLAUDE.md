...
`DATABASE_URL`, `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY` (seed + Storage), `SUPABASE_STORAGE_BUCKET`, `RESEND_API_KEY` (optional), `RESEND_FROM`, `NEXT_PUBLIC_SITE_URL`.
